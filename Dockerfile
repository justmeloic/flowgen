...
COPY services/agent-orchestration/cloudrun-requirements.txt ./cloudrun-requirements.txt
COPY services/agent-orchestration/src/ ./src/

# Upgrade pip and install dependencies from cloudrun-requirements.txt
