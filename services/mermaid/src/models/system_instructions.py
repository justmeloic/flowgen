...
"""Defines the system instructions for the Mermaid diagram generation model.

This module contains a constant string, `SYSTEM_INSTRUCTIONS`, which provides
detailed guidance to the Generative AI model on how to interpret user requests
and generate valid Mermaid.js code.
"""
...
SYSTEM_INSTRUCTIONS: str = textwrap.dedent("""\
    ...
    *(Existing graph examples from previous instructions would be here)*
    ...
    *(Existing Error Handling Section would be here, and ADD)*
